...
1. What is the DOM?
        ...
        An application programming interface for  HTML that defines the logical structure of documents and the way a document is accessed and manipulated

2. What is an event?

        A signal received by a program as a result of some action taken by the user, or because something else has happened
...
4. Why would we convert a NodeList into an Array?
        ...
        to have access to the methods of an array

5. What is a component?

        small, potentially re-usable set of logic, behaviors and interface elements
